...
### Authentication
When you log into your email account with your username and password, you are authenticating to the email server that you are the person that owns the account, and that you are the person that should be reading emails sent to you. Email servers can verify that your emails are protected using [Multi-Factor Authentication (MFA)](Authentication.md), [Sender Policy Framework (SPF)](Authentication.md), and [DomainKeys Identified Mail (DKIM)](Authentication.md). All of these systems work to ensure that you are the only person that is accessing your emails. 
